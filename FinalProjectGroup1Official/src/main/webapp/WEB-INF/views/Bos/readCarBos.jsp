        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"> 部落格文章管理 </h1>
                    <P align="right"> <a href="<c:url value='/queryCarBos'/>">查看所有文章</a> 
                    </P>
                   <!-- 
	...
	<!-- <c:choose>
	 ...
	 <tr>
	  ...
	  <div class="form-group row"> 
	   ...
	   <tr>
	      <td>文章日期：</td>
	      <td  width='360'>
	      	<form:input path="name" style='width:100%;height:40px;' placeholder="ex.2020/20/20"/><br>&nbsp;	
	   ...
	   <tr>
	    ...
	    <tr>
	      <td>文章分類：</td>
	   	  <td>
	   	  	 <form:input path="seat" style='width:100%;height:40px;' placeholder="飯店、景點、活動..." /><br>&nbsp;
	  ...
	  <div class="form-group row">
		...
		<div class="col-sm-12 mb-3 mb-sm-0">
		   <td>文章內容：</td>
	   	  <td>
	      	<form:textarea  path="address" style='width:100%' rows="6"/><br>&nbsp;	
	 ...
	 <div class="form-group row"> 
	   ...
	   <tr>
	      <td>文章標籤：</td>
	        <td  width=''>
	      	<form:input path="suitcase" style='width:100%;height:40px;' placeholder="圓山飯店.木柵夜景..."/><br>&nbsp;	
		 ...
		 <tr>
	      <td>連結備註：</td>
		  <td  width=''>
		  <form:input path='handbag' style='width:100%;height:40px;' placeholder="部落格網址!"/><br>&nbsp;	
