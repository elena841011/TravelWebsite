...
<tr>
<td><a href="<c:url value='/joelin'/>"><img src="ImagesAdmin/hotelsicon.png" alt="無法顯示圖片" width="30%"></a>
</td>
<td><a href="<c:url value='/wade'/>"><img src="ImagesAdmin/rentcar.jpg" alt="無法顯示圖片" width="30%"></a>
</td>
...
<tr>
<td><a href="<c:url value='/sylvia'/>"><img src="ImagesAdmin/eventsicon.png" alt="無法顯示圖片" width="30%"></a>
</td>
<td><a href="<c:url value='/bos'/>"><img src="ImagesAdmin/blogicons.png" alt="無法顯示圖片" width="30%"></a>
</td>
