        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">更新會員資料
                    </h1>
...
地址:&nbsp;&nbsp;<form:input class="inputLbox" type = "text" size="40" id="idaddress" path = "address" value = "${CustomerInfo.address}"/>
<img id="saddressimg"><span id="saddresssp"></span>
<p class="rule">(不可空白)</p>
<hr>
