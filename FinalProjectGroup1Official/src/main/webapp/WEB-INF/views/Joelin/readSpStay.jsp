...
<html lang="en">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="<%=basePath%>/readSpStay/assets/favicon.ico" />
        <!-- Bootstrap icons-->
        <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css" rel="stylesheet" />
        <!-- Core theme CSS (includes Bootstrap)-->
        <link href="<%=basePath%>/readSpStay/css/styles.css" rel="stylesheet" />
    ...
    <body >
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand"  href="<c:url value="/"/>"><img src="<%=basePath%>/AdminTemplate/img/Blue.png"/></a>
            ...
            <section class="py-5 bg-light" id="scroll-target">
                <div class="container px-5 my-5">
                    <div class="row gx-5 align-items-center">
                        <div class="col-lg-6"><img id="presentimg" width='600' height='460' src=" ${stay.pictureString} " alt="..." /></div>
                        <div class="col-lg-6">
                            <p># ${stay.number} </p>
                            <h3 class="fw-bolder"> ${stay.hotel} </h3>
                            <hr>
                            <p class="lead fw-normal text-muted mb-0"> ${stay.content} <br>
                             <hr>
                              ${stay.address} <br></p>
