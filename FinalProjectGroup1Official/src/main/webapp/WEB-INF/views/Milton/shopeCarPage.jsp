...
<!-- Page Wrapper -->
  ...
  <!-- Begin Page Content --> 
<div class="container-fluid">   
 <h1 class="h3 mb-2 text-gray-800">購物車 </h1>
...
<%--     <a href="<c:url value='/hello' />"> Hello World </a><br>  --%>
  ...
  <div class="btn-group py-3" >
    ...
    &nbsp;<a href="<c:url value='/readfile/excel/adc' />"><button type="button" class="btn btn-primary">匯入初始資料</button></a>&nbsp;
    &nbsp;<a href="<c:url value='/queryRestaurant' />"><button type="button" class="btn btn-primary">新增商品資料</button> </a>&nbsp;
    &nbsp;<a href="<c:url value='/insertRestaurant' />"><button type="button" class="btn btn-primary">購買商品資料</button></a> &nbsp;
    </div>
    <hr class="sidebar-divider my-0" >
    
  
          <!--table 內容 -->
                     <div class="table-responsive" id="dataArea">  </div>               
    
    <hr >
    <div class="btn-group py-3">
    &nbsp;<a href="<c:url value='/insertType' />"><button type="button" class="btn btn-primary">新增類型資料</button></a> &nbsp;
    &nbsp;<a href="<c:url value='/queryType' />"><button type="button" class="btn btn-primary">查詢類型資料</button></a>
    </div>
    <hr rclass="sidebar-divider my-0" >
  ...
  <script>
		$(function(){
			...
			function showAllData (){
				...
				xhr.open('GET', "<c:url value='/findAllCart' />", true);
				xhr.send();
			...
			function showData(textData) {
				let cartsMap = JSON.parse(textData);
				let carts = cartsMap.cart;
				let segment = ""
				...
				for (n = 0; n < carts.length; n++) {
					...
					segment += "<tr>";
					segment += "<td class='idX'>" + car.userOrderId + "</td>";
					segment += "<td >" + car.productname + "</td>";
					segment += "<td >" + car.productprice + "</td>";
					segment += "<td >" + car.customerId + "</td>";
