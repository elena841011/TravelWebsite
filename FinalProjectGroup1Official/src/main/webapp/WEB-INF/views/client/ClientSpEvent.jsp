...
function showData(textData){
	...
	for(n = 0 ; n < events.length ; n++ ){
		let event = events[n];
		let tmpurl1 ="<c:url value='/readSpEvent/' />" + event.id;
       ...
       segment +=	 "<img class='card-img-top' src='" + event.pictureString +"'/>";
       segment +=	 "<div class='card-body p-4'>";
       segment +=	 "<div class='text-center'>";
		
	//   segment +=	 "<h5 class='fw-bolder'>&nbsp;" + tmpurl0 +"&nbsp;</td>";
	   segment +=	 "<h5 class='fw-bolder'>&nbsp;" + event.name +"&nbsp;</td>";
	   segment +=	 "<br>&nbsp;" + ' $ ' + event.price  +"&nbsp;";
	   segment +=	 "</div>";
	   segment +=	 "</div>";
            ...
            <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <svg class="bd-placeholder-img" width="100%" height="100%"  aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false" viewBox="0 0 1920 500"><image xlink:href="img/banner-4.jpg" ></image></svg>
                ...
                <div class="carousel-item">
                  ...
                  <svg class="bd-placeholder-img" width="100%" height="100%"  aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false" viewBox="0 0 1920 500" ><image xlink:href="img/banner-5.jpg" ></image></svg>
