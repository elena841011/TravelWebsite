...
public class CarController {
	...
	@GetMapping(value="/findAllCar",produces = "application/json; charset=UTF-8")
	public @ResponseBody List<Car> findAll(){
		return carService.findAll();		
	}
	
    
	@GetMapping(value="/findByIdCar/{id}", produces = "application/json; charset=UTF-8")
	...
	@GetMapping(value="/queryByNameCar", produces = "application/json; charset=UTF-8")
...
*/		
	@GetMapping(value="/findByNameCar", produces = "application/json; charset=UTF-8")
